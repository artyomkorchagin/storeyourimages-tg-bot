...
func (s *Service) GetUserStatus(ctx context.Context, userID string) (string, error) {
...
func (s *Service) ChangeUserStatus(ctx context.Context, userID, status string) error {
